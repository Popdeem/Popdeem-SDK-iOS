...
//        if (![reward.brand isKindOfClass:[NSNull class]] && reward.brand.name) {
//            [self.brandLabel setText:reward.brand.name];
//            if (reward.coverImage) {
//                [self.logoImageView setImage:reward.coverImage];
//            } else {
//                UIImage *img = [WalletCache imageForReward:reward];
//                if (img) {
//                    [self.logoImageView setImage:img];
//                } else {
...
//        }
        ...
        [_rulesLabel setFont:[UIFont systemFontOfSize:14]];
        ...
        UILabel *howToTitle = [[UILabel alloc] initWithFrame:CGRectMake(indent, 20, viewWidth-2*indent, 20)];
        [howToTitle setFont:[UIFont systemFontOfSize:14]];
        [howToTitle setTextColor:[UIColor blackColor]];
        [backingView addSubview:howToTitle];
        
        UILabel *howToLabel = [[UILabel alloc] initWithFrame:CGRectMake(indent, 40, viewWidth-2*indent, 190-120)];
        [howToLabel setFont:[UIFont systemFontOfSize:14]];
        ...
        if (reward.type == PDRewardTypeCoupon  || reward.type == PDRewardTypeInstant) {
            ...
            [redeemButton.titleLabel setFont:[UIFont systemFontOfSize:16]];
