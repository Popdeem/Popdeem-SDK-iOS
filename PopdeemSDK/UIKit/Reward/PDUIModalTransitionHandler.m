...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
  ...
  if (self.presenting) {
    ...
    CGRect navBarFrame = ((PDUINavigationController*)toViewController).navigationBar.frame;
    ((PDUINavigationController*)toViewController).navigationBar.frame = CGRectMake(navBarFrame.origin.x, 0, navBarFrame.size.width, navBarFrame.size.height);
